...
- 6.6 patches
  -  [kernel-6.6.10-200.fc39](https://koji.fedoraproject.org/koji/buildinfo?buildID=2341540) *The CPU scheduler is changed to EEVDF. BMQ and PDS are not used anymore.*
  -  [kernel-6.6.10-100.fc38](https://koji.fedoraproject.org/koji/buildinfo?buildID=2341539) *The CPU scheduler is changed to EEVDF. BMQ and PDS are not used anymore.*
- 6.5 patches
