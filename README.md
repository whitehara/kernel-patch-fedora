...
- 6.5 patches
  -  [kernel-6.5.9-300.fc39](https://koji.fedoraproject.org/koji/buildinfo?buildID=2311765) *CONFIG_MLX5_CORE is not enabled for preventing a BUG.*
  -  [kernel-6.5.9-200.fc38](https://koji.fedoraproject.org/koji/buildinfo?buildID=2311763) *CONFIG_MLX5_CORE is not enabled for preventing a BUG.*
  -  [kernel-6.5.9-100.fc37](https://koji.fedoraproject.org/koji/buildinfo?buildID=2311762) *CONFIG_MLX5_CORE is not enabled for preventing a BUG.*
- 6.4 patches
